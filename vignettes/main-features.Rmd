...
<img src="figure/fig-solution-paths-1.png" alt="Figure 1: Solution paths produced by `cv_gspcr`."  />
...
<div class="figure" style="text-align: center">
<img src="figure/fig-association-measures-1.png" alt="Figure 2: Solution paths for different association measures."  />
<p class="caption">Figure 2: Solution paths for different association measures.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/fig-fit-measures-1.png" alt="Figure 3: Solution paths for different fit measures."  />
<p class="caption">Figure 3: Solution paths for different fit measures.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/fig-fit-measures-npc-5-1.png" alt="Figure 4: Solution paths for different fit measures when using 5 PCs."  />
<p class="caption">Figure 4: Solution paths for different fit measures when using 5 PCs.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/fig-cv-npcs-1.png" alt="Figure 5: Solution paths for different fit measures when cross-validating the number of PCs."  />
<p class="caption">Figure 5: Solution paths for different fit measures when cross-validating the number of PCs.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/fig-comp-superpc-solution-path-1.png" alt="Figure 6: Solution paths obtained with `superpc`."  />
<p class="caption">Figure 6: Solution paths obtained with `superpc`.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/fig-comp-gspcr-solution-path-1.png" alt="Figure 7: Solution paths obtained with `gspcr`."  />
<p class="caption">Figure 7: Solution paths obtained with `gspcr`.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/fig-cv-check-1.png" alt="Figure 8: Solution paths for different fit measures using K-fold CV."  />
<p class="caption">Figure 8: Solution paths for different fit measures using K-fold CV.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/fig-cv-check-no-cv-1.png" alt="Figure 9: Solution paths for different fit measures without using K-fold CV."  />
<p class="caption">Figure 9: Solution paths for different fit measures without using K-fold CV.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/fig-1se-rule-1.png" alt="Figure 10: Solution paths for different fit measures when using the 1-standard-error rule."  />
<p class="caption">Figure 10: Solution paths for different fit measures when using the 1-standard-error rule.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/fig-no-cv-1.png" alt="Figure 11: Solution paths obtained using fit measures that do not need K-fold CV."  />
<p class="caption">Figure 11: Solution paths obtained using fit measures that do not need K-fold CV.</p>
</div>
