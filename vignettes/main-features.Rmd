...
![Solution paths for different association measures.](figure/fig-association-measures-1.png)
...
![Solution paths for different fit measures.](figure/fig-fit-measures-1.png)
...
![Solution paths for different fit measures when using 5 PCs.](figure/fig-fit-measures-npc-5-1.png)
...
![Solution paths for different fit measures when cross-validating the number of PCs.](figure/fig-cv-npcs-1.png)
...
![Solution paths for different fit measures using K-fold CV.](figure/fig-cv-check-1.png)
...
![Solution paths for different fit measures without using K-fold CV.](figure/fig-cv-check-no-cv-1.png)
...
![Solution paths for different fit measures when using the 1-standard-error rule.](figure/fig-1se-rule-1.png)
...
![Solution paths obtained using fit measures that do not need K-fold CV.](figure/fig-no-cv-1.png)
