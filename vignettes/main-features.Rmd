...
<img src="figure/solution_paths-1.png" alt="Figure 1: Solution paths produced by `cv_gspcr`."  />
...
<div class="figure" style="text-align: center">
<img src="figure/fig-cv-check-1.png" alt="Figure 6: Solution paths for different fit measures using K-fold CV."  />
<p class="caption">Figure 6: Solution paths for different fit measures using K-fold CV.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/fig-cv-check-no-cv-1.png" alt="Figure 7: Solution paths for different fit measures without using K-fold CV."  />
<p class="caption">Figure 7: Solution paths for different fit measures without using K-fold CV.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/fig-1se-rule-1.png" alt="Figure 8: Solution paths for different fit measures when using the 1-standard-error rule."  />
<p class="caption">Figure 8: Solution paths for different fit measures when using the 1-standard-error rule.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/fig-no-cv-1.png" alt="Figure 9: Solution paths obtained using fit measures that do not need K-fold CV."  />
<p class="caption">Figure 9: Solution paths obtained using fit measures that do not need K-fold CV.</p>
</div>
