...
<img src="fig-comp-superpc-solution-path-1.svg" alt="Figure 1: Solution paths obtained with `superpc`."  />
...
<div class="figure" style="text-align: center">
<img src="fig-comp-gspcr-solution-path-1.svg" alt="Figure 2: Solution paths obtained with `gspcr`."  />
...
<div class="figure" style="text-align: center">
<img src="fig-cv-check-1.svg" alt="Figure 3: Solution paths for different fit measures using K-fold CV."  />
...
<div class="figure" style="text-align: center">
<img src="fig-cv-check-no-cv-1.svg" alt="Figure 4: Solution paths for different fit measures without using K-fold CV."  />
...
<div class="figure" style="text-align: center">
<img src="fig-1se-rule-1.svg" alt="Figure 5: Solution paths for different fit measures when using the 1-standard-error rule."  />
...
<div class="figure" style="text-align: center">
<img src="fig-no-cv-1.svg" alt="Figure 6: Solution paths obtained using fit measures that do not need K-fold CV."  />
