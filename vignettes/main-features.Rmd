...
which can be compared to the solution we obtained when using CV

```{r }
# Print the solutions using standard rule and CV
round(t(res_1se), 3)

```

As you can see, had we not chosen the
